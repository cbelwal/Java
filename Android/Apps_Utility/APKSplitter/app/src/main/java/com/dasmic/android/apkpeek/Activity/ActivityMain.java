...
public class ActivityMain extends ActivityBaseMain
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helpURL =
                "http://www.coju.mobi/android/apkpeek/faq/index.html";
        demo_video_id = "YOkCbNfK5Oo";
        ...
        //Replace File provider with the APKit file provider
        ActivityOptions.FILE_PROVIDER_AUTHORITY="com.dasmic.apkpeek.FileProvider";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.action_delete:
                onButtonDelete();
                break;
            case R.id.action_split_apk:
                onSplitAPK(ActivityOptions.FILE_PROVIDER_AUTHORITY,
                            getString(R.string.message_tellafriend));
                break;

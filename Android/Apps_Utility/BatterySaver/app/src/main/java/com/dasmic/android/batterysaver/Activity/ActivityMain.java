...
import com.dasmic.android.batterysaver.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.batterysaver.proversion"; //Dont change location

        helpURL =
                "http://www.coju.mobi/android/batterysaver/faq/index.html";
        demo_video_id = "ppOJEQCVXoE";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.batterysaver.fileprovider";
    ...
    protected void additionalPostDisplayFunction()
    {
        SupportFunctions.DisplayToastMessageLong(getActivity(),
                getString(R.string.message_battery_current_percentage) +
                getCurrentBatterState());
    }
    ...
    protected void setLocalVariablesAndEventHandlers() {
        ...
        _vmApps.setCurrentDisplayOption(
                DisplayOptionsEnum.CurrentlyRunning);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.nav_view_currently_running:
                refresh=true;
                _vmApps.setCurrentDisplayOption(
                        DisplayOptionsEnum.CurrentlyRunning);
                break;
            ...
            switch (requestCode) {
                case (ActivityOptions.FILTER_ACTIVITY_REQUEST):
                    if (resultCode == Activity.RESULT_OK)
                        ReloadListView();
                    break;
                case (ActivityOptions.STOP_PROCESES_ACTIVITY_REQUEST):
                    if (resultCode == Activity.RESULT_OK)
                        ReloadListView();
                    break;

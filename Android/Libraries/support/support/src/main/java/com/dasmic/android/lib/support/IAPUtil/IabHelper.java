...
package com.dasmic.android.lib.support.IAPUtil;
...
public class IabHelper {
    ...
    void checkSetupDone(String operation) {
        if (!mSetupDone) {
            //To prevent the large number of crashes that are happening
            //wait for 5 seconds to complete the setup before popping error
            //Added on 26h Aug, 2018, check crashed after this date

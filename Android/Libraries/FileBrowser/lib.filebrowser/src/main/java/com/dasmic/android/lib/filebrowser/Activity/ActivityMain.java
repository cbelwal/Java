...
public class ActivityMain extends ActivityBaseMain
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityStartupData activityData =   mIntent.getParcelableExtra("asd");
        setValuesFromActivityData(activityData);
        //Do this before calling Super
        setContentView(R.layout.ui_main_fb);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if(id == R.id.nav_view_action_close)
        {

...
public class ViewModelBluetoothConnection {
    ...
    private static final UUID MY_UUID_SECURE =
            UUID.fromString("fe1d8ec4-115f-11e7-93ae-92361f002671"); //Different from Coju

    private static final String TAG = "dasmic.calllog";
    private static final String NAME_SECURE = "dasmic.dasmic.calllog";

 ...
 */
public class vCardImportOutlookTest {
    private static final String CrLf ="\r\n";

    private final String vCardOutlook=
            "BEGIN:VCARD"+ CrLf +
                    "VERSION:2.1"+ CrLf +
                    "N;LANGUAGE=en-us:Belwal;Chaitanya;VCF"+ CrLf +
                    "FN:Chaitanya Middle Belwal"+ CrLf +
                    "TEL;WORK;VOICE:+1 (281) 222-3975"+ CrLf +
                    "TEL;HOME;VOICE:+1 (832) 965-6497"+ CrLf +
                    "TEL;CELL;VOICE:+1 (832) 965-6497"+ CrLf +
                    "ADR;HOME;PREF:;;9222 Symphonic Ln.,;Houston;TX;77040;USA"+ CrLf +
                    "LABEL;HOME;PREF;ENCODING=QUOTED-PRINTABLE:9222 Symphonic Ln.,=0D=0A="+ CrLf +
                    "Houston, TX 77040=0D=0A="+ CrLf +
                    "USA"+ CrLf +
                    "X-MS-OL-DEFAULT-POSTAL-ADDRESS:1"+ CrLf +
                    "X-MS-CARDPICTURE;TYPE=JPEG;ENCODING=BASE64:" + CrLf +
                            "/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAIBAQEBAQIBAQE"+ CrLf +
                    "CAgICAgQDAgICAgUEBAMEBgUGBgYFBgYGBwkIBgcJBwYGCAsICQoKCgoKBggLDAsKDAkKCgr/"+ CrLf +
                    "2wBDAQICAgICAgUDAwUKBwYHCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKC"+ CrLf + "goKCgoKCgoKCgoKCgr/wAARCABgAGADASIAAhEBAxEB/8QAHwAAAQUBAQEBAQEAAAAAAAAAAA"+ CrLf +
                    ...
                    CrLf +
                    "EMAIL;PREF;INTERNET:cbelwal@gmail.com"+ CrLf +
                    "X-MS-OL-DESIGN;CHARSET=utf-8:<card xmlns>"+ CrLf +
                    "REV:20151126T214534Z"+ CrLf +
                    "END:VCARD";


    @Test
    public void testSetFromOutlookString() throws Exception {
        DataContactTransfer dct = new DataContactTransfer(0);
        dct.setFromVCardString(vCardOutlook);

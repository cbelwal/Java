package com.dasmic.android.mergecontacts.Activity;
...
import com.dasmic.android.mergecontacts.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/mergecontacts/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.mergecontacts.paidversion";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.mergecontacts.FileProvider";
        demo_video_id = "6Y3OR3W7c70";

        HelpMedia.ShowDemoVideoDialog(this,demo_video_id);
        ActivityOptions.FREE_VERSION_CONTACT_LIMIT=30; //Set to 30
        SupportFunctions.DisplayToastMessageLong(this,
                getString(R.string.message_on_load_toast));
        HelpMedia.showHelpDialog(this,
                getString(R.string.message_on_load_dialog));

package com.dasmic.android.duplicatesdelete.Activity;
...
import com.dasmic.android.duplicatesdelete.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/duplicatesvd/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.duplicatesdelete.paidversion";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.duplicatesdelete.FileProvider";


        demo_video_id = "Ptl7wEFFmtw";
    ...
    private void setDrawerMenu(){
        ...
        //navigationView.inflateHeaderView(R.layout.nav_header_ui_main);
    }

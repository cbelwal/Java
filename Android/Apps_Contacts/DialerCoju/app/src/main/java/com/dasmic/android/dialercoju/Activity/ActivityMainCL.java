package com.dasmic.android.dialercoju.Activity;
...
import com.dasmic.android.dialercoju.R;
...
public class ActivityMainCL extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/dialercoju/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.dialercoju.proversion";
        ...
        AppOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.dialercoju.FileProvider";
        demo_video_id = "NiE7rMLck6g";
        HelpMedia.ShowDemoVideoDialog(this,demo_video_id,1); //Show video in second trial
        setSortButton();
        //Subscribe to generic message to all apps
        FirebaseMessaging.getInstance().subscribeToTopic("Updates.General");
        _isDefaultCallHandler = true;
        askUserToSetAsDefaultDialer();
        //ListView will be loaded if askUserToSetAsDefaultDialer() is successful
    }

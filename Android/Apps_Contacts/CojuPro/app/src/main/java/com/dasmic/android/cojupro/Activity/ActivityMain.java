package com.dasmic.android.cojupro.Activity;
...
import com.dasmic.android.cojupro.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/coju/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ActivityOptions.IS_FOR_AMAZON) {
            ...
            _paid_version_sku_id =
                    "com.dasmic.android.coju.paidversion";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.cojupro.FileProvider";
        demo_video_id = "hhfZsWcU5Kc";

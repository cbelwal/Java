package com.dasmic.android.ContactViewFree.Activity;
...
import com.dasmic.android.ContactViewFree.Activity.ActivityAux.AppSpecificFunctions;
...
public class ActivityMain extends ActivityBaseMain
    ...
    AppSpecificFunctions _asf=
            new AppSpecificFunctions();

    final String helpURL =
            "http://www.coju.mobi/android/contactsview/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.contactviewer.paidversion";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.contactview.FileProvider";
    ...
    private void setLocalVariablesAndEventHandlers() {
        ...
        _vmContacts.changeSortOrder(); //Set to desc

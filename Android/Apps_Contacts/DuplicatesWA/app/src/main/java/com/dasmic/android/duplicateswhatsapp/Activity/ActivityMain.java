package com.dasmic.android.duplicateswhatsapp.Activity;
...
import com.dasmic.android.lib.contacts.Activity.ActivityDuplicatesWhatsApp;
...
import com.dasmic.android.duplicateswhatsapp.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/duplicateswhatsapp/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.duplicateswhatsapp.paidversion";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.duplicateswhatsapp.FileProvider";

        demo_video_id = "0I5srZM6fEQ";
    ...
    private void setLocalVariablesAndEventHandlers() {
        ...
        _vmContacts.setCurrentDisplayOption(DisplayOptionsEnum.AllInformationWhatsApp);
        _vmContacts.setIsForWhatsApp();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        Intent myIntent;
        switch(id){
            case R.id.nav_view_whatsapp_all:
                _vmContacts.setCurrentDisplayOption(DisplayOptionsEnum.AllInformationWhatsApp);
                refresh=true;
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id)
        {
            ...
            case R.id.action_duplicates:
                myIntent = new Intent(this, ActivityDuplicatesWhatsApp.class);

package com.dasmic.android.contactsxchangewa.Activity;
...
import com.dasmic.android.contactsxchangewa.R;
...
public class ActivityMain extends ActivityBaseMain
    ...
    final String helpURL =
            "http://www.coju.mobi/android/contactsxchangewa/faq/index.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _paid_version_sku_id =
                "com.dasmic.android.contactsxchangewa.paid";
        ...
        ActivityOptions.FILE_PROVIDER_AUTHORITY=
                "com.dasmic.contactsxchangewa.FileProvider";
        demo_video_id = "bICB5EDpUjA";
        HelpMedia.ShowDemoVideoDialog(this, demo_video_id);
        ActivityOptions.FREE_VERSION_CONTACT_LIMIT=180;
    ...
    protected int getColor(DataContactDisplay contact){
        ...
        int color= ContextCompat.getColor(
                this, R.color.ContactBackgroundColor);
